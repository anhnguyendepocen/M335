...
cat("\n\n")
cat("--------\n\n")
md_bullet(tasks, group = list("Number" = 4), lines.keep = 1:4)
...
cat("\n\n")
md_bullet(tasks, group = list("Number" = 8), lines.keep = 1:3)
cat("\n\n")
cat("--------\n")
md_bullet(cases, group = list("Number" = 12), lines.keep = 1:4)
