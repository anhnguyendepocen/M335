...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 4: Becoming a databender"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 6: World Data Investigations - Part 2"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 7: Same Data Different Format"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 8: Clean and Reformat (aka tidy)"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 9: Take me out to the ball game"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 10: Strings and grep"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 11: Controlling categorical variables (factors)"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 12: Counting Words and Occurrences"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 13:  How is the weather?"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 14: Does the weather hurt my bottom line?"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 15: My investment is better than yours"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 16: The US Grocer (KR)"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 17: Building Functions"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 18: Making bad graphics"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Case Study 3: Reducing Gun Deaths (FiveThirtyEight)"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Case Study 4: I can clean your data"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "##  Case Study 5: The collapse of construction in Idaho"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Case Study 6: Counting names in scripture"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Case Study 7: It's about time"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Case Study 8: Interacting with time"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Case Study 9: Get your project moving"
if (params$pbackground == TRUE) background.title <- "\n### Background"
