...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 15:  How is the weather?"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 16: Does the weather hurt my bottom line?"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 24: A Few views on Visualization"
if (params$pbackground == TRUE) background.title <- "\n### Background"
