...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 3:  Let's git going"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 4:  Asking the right questions"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 5: Making bad graphics"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 6: World Data Investigation"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 7: World Data Investigations - Part 2"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 8: Data to Answer Questions"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 11: Take me out to the ball game"
if (params$pbackground == TRUE) background.title <- "\n### Background"
...
title.text <- NULL
background.title <- NULL
if (params$ptitle == TRUE) title.text <- "## Task 12: Strings and grep"
if (params$pbackground == TRUE) background.title <- "\n### Background"
