...
1. Merge all four data sets into a table that looks like the table below.  **Note that this activity is teaching how to merge data sets and check for poor merges.**
